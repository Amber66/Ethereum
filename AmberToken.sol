...
// Author: Amber.li.66@yahoo.com
contract AmberToken is Ownable, StandardToken {

    string public name = "Amber Token";          // name of the token
    string public symbol = "ABT";              // ERC20 compliant 4 digit token code
    uint public decimals = 18;                  // token has 18 digit precision

    uint public totalSupply = 100 * 1000 * 1000 ether;  // total supply of 100 Million Tokens

    // @notice Initializes the contract and allocates all initial tokens to the owner
    function AmberToken() public {
